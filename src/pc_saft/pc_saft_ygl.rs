...
/// methanol.set_ygl_assoc_type(0.035176, 2899.5, 0.0); // kappa_AB epsilon_AB
...
impl PcSaftYglPure {
    ...
    pub fn set_ygl_assoc_type(&mut self, kappa_AB: f64, epsilon_AB: f64, b_assoc: f64) {
...
impl PcSaftYglPure {
    fn set_temperature_and_number_density(&mut self, temp: f64, rho_num: f64) {
        ...
        if self.no_assoc_term {
            ...
            self.XA = (-(1.0 - self.b_assoc * t)
                + ((1.0 - self.b_assoc * t).powi(2) + 4.0 * (1.0 + self.b_assoc) * t).sqrt())
                / (2.0 * (1.0 + self.b_assoc) * t);
        }
    }
...
impl PcSaftYglPure {
    fn assoc_t0d0(&self) -> f64 {
        if self.no_assoc_term {
            ...
            self.XA.ln()
                + (self.b_assoc * self.XA + 1.0 - self.b_assoc).ln()
                + ((1.0 + self.b_assoc) * self.XA - self.b_assoc).ln()
                - (1.0 + self.b_assoc) * self.XA
                + (1.0 + self.b_assoc)
        }
    }
    fn assoc_t0d1(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t0d1(1.0, self.XA)
                + self.site_t0d1(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t0d1(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
        }
    }
    fn assoc_t0d2(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t0d2(1.0, self.XA)
                + self.site_t0d2(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t0d2(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t0d3(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t0d3(1.0, self.XA)
                + self.site_t0d3(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t0d3(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t0d4(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t0d4(1.0, self.XA)
                + self.site_t0d4(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t0d4(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t1d0(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t1d0(1.0, self.XA)
                + self.site_t1d0(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t1d0(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t1d1(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t1d1(1.0, self.XA)
                + self.site_t1d1(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t1d1(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t1d2(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t1d2(1.0, self.XA)
                + self.site_t1d2(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t1d2(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t1d3(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t1d3(1.0, self.XA)
                + self.site_t1d3(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t1d3(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
    ...
    fn assoc_t2d0(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.site_t2d0(1.0, self.XA)
                + self.site_t2d0(self.b_assoc, self.b_assoc * self.XA + 1.0 - self.b_assoc)
                + self.site_t2d0(
                    1.0 + self.b_assoc,
                    (1.0 + self.b_assoc) * self.XA - self.b_assoc,
                )
...
impl PcSaftYglPure {
    fn site_t0d1(&mut self, c: f64, x: f64) -> f64 {
        c * self.site_x1(x) * self.x_t0d1()
    }
    fn site_t0d2(&mut self, c: f64, x: f64) -> f64 {
        c.powi(2) * self.site_x2(x) * self.x_t0d1().powi(2) + c * self.site_x1(x) * self.x_t0d2()
    }
    fn site_t0d3(&mut self, c: f64, x: f64) -> f64 {
        c.powi(3) * self.site_x3(x) * self.x_t0d1().powi(3)
            + 3.0 * c.powi(2) * self.site_x2(x) * self.x_t0d1() * self.x_t0d2()
            + c * self.site_x1(x) * self.x_t0d3()
    }
    fn site_t0d4(&mut self, c: f64, x: f64) -> f64 {
        c.powi(4) * self.site_x4(x) * self.x_t0d1().powi(4)
            + 6.0 * c.powi(3) * self.site_x3(x) * self.x_t0d1().powi(2) * self.x_t0d2()
            + 3.0 * c.powi(2) * self.site_x2(x) * self.x_t0d2().powi(2)
            + 4.0 * c.powi(2) * self.site_x2(x) * self.x_t0d1() * self.x_t0d3()
            + c * self.site_x1(x) * self.x_t0d4()
    }
    fn site_t1d0(&mut self, c: f64, x: f64) -> f64 {
        c * self.site_x1(x) * self.x_t1d0()
    }
    fn site_t1d1(&mut self, c: f64, x: f64) -> f64 {
        c.powi(2) * self.site_x2(x) * self.x_t1d0() * self.x_t0d1()
            + c * self.site_x1(x) * self.x_t1d1()
    }
    fn site_t1d2(&mut self, c: f64, x: f64) -> f64 {
        c.powi(3) * self.site_x3(x) * self.x_t1d0() * self.x_t0d1().powi(2)
            + 2.0 * c.powi(2) * self.site_x2(x) * self.x_t1d1() * self.x_t0d1()
            + c.powi(2) * self.site_x2(x) * self.x_t1d0() * self.x_t0d2()
            + c * self.site_x1(x) * self.x_t1d2()
    }
    fn site_t1d3(&mut self, c: f64, x: f64) -> f64 {
        c.powi(4) * self.site_x4(x) * self.x_t1d0() * self.x_t0d1().powi(3)
            + 3.0 * c.powi(3) * self.site_x3(x) * self.x_t1d1() * self.x_t0d1().powi(2)
            + 3.0 * c.powi(3) * self.site_x3(x) * self.x_t1d0() * self.x_t0d1() * self.x_t0d2()
            + 3.0 * c.powi(2) * self.site_x2(x) * self.x_t1d2() * self.x_t0d1()
            + 3.0 * c.powi(2) * self.site_x2(x) * self.x_t1d1() * self.x_t0d2()
            + c.powi(2) * self.site_x2(x) * self.x_t1d0() * self.x_t0d3()
            + c * self.site_x1(x) * self.x_t1d3()
    }
    fn site_t2d0(&mut self, c: f64, x: f64) -> f64 {
        c.powi(2) * self.site_x2(x) * self.x_t1d0().powi(2) + c * self.site_x1(x) * self.x_t2d0()
    }
}
impl PcSaftYglPure {
        ...
        if self.xt1.0 != self.XA {
            self.xt1 = (
                ...
                (self.rho_num * self.kappa_AB_sigma3)
                    * (self.XA * (self.XA + self.b_assoc * self.XA - self.b_assoc)).powi(2)
                    / ((1.0 + self.b_assoc) * self.XA.powi(2)
                        - 2.0 * (1.0 + self.b_assoc) * self.XA
                        + self.b_assoc),
            )
        }
        self.xt1.1
        ...
        if self.xt2.0 != self.XA {
            self.xt2 = (
                ...
                2.0 * (self.rho_num * self.kappa_AB_sigma3).powi(2)
                    * (self.XA * (self.XA + self.b_assoc * self.XA - self.b_assoc)).powi(3)
                    / ((1.0 + self.b_assoc) * self.XA.powi(2)
                        - 2.0 * (1.0 + self.b_assoc) * self.XA
                        + self.b_assoc)
                        .powi(3)
                    * ((1.0 + self.b_assoc).powi(2) * self.XA.powi(3)
                        - 3.0 * (1.0 + self.b_assoc).powi(2) * self.XA.powi(2)
                        + (3.0 * self.b_assoc * (1.0 + self.b_assoc) * self.XA
                            - self.b_assoc.powi(2))),
            )
        }
        self.xt2.1
        ...
        if self.xt3.0 != self.XA {
            self.xt3 = (
                ...
                6.0 * (self.rho_num * self.kappa_AB_sigma3).powi(3)
                    * (self.XA * (self.XA + self.b_assoc * self.XA - self.b_assoc)).powi(4)
                    / ((1.0 + self.b_assoc) * self.XA.powi(2)
                        - 2.0 * (1.0 + self.b_assoc) * self.XA
                        + self.b_assoc)
                        .powi(5)
                    * ((1.0 + self.b_assoc).powi(4) * self.XA.powi(6)
                        - 6.0 * (1.0 + self.b_assoc).powi(4) * self.XA.powi(5)
                        + 5.0
                            * (3.0 * self.b_assoc + 2.0)
                            * (1.0 + self.b_assoc).powi(3)
                            * self.XA.powi(4)
                        - 20.0 * self.b_assoc * (1.0 + self.b_assoc).powi(3) * self.XA.powi(3)
                        + self.b_assoc.powi(2)
                            * (15.0 * self.b_assoc + 16.0)
                            * (1.0 + self.b_assoc)
                            * self.XA.powi(2)
                        - (6.0 * self.b_assoc.powi(3) * (1.0 + self.b_assoc) * self.XA
                            - self.b_assoc.powi(4))),
            )
        }
        self.xt3.1
        ...
        if self.xt4.0 != self.XA {
            self.xt4 = (
                ...
                24.0 * (self.rho_num * self.kappa_AB_sigma3).powi(4)
                    * (self.XA * (self.XA + self.b_assoc * self.XA - self.b_assoc)).powi(5)
                    / ((1.0 + self.b_assoc) * self.XA.powi(2)
                        - 2.0 * (1.0 + self.b_assoc) * self.XA
                        + self.b_assoc)
                        .powi(7)
                    * ((1.0 + self.b_assoc).powi(6) * self.XA.powi(9)
                        - 9.0 * (1.0 + self.b_assoc).powi(6) * self.XA.powi(8)
                        + (36.0 * self.b_assoc + 29.0)
                        ...
                        - 3.0
                            ...
                            * (1.0 + self.b_assoc)
                            * self.XA.powi(2)
                        + (9.0 * self.b_assoc.powi(5) * (1.0 + self.b_assoc) * self.XA
                            - self.b_assoc.powi(6))),
            )
        }
        self.xt4.1
...
mod tests {
    ...
    fn test_pc_saft_pure() {
        ...
        let mut methanol = PcSaftYglPure::new_fluid(1.5255, 3.23, 188.9);
        methanol.set_ygl_assoc_type(0.035176, 2899.5, 0.5);
