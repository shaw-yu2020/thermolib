...
impl PcSaftYglPure {
    ...
    pub fn set_ygl_assoc_type(&mut self, kappa_ab: f64, epsilon_ab: f64, b_params: f64) {
        self.no_assoc_term = false;
        self.kappa_ab_plus = kappa_ab * self.sigma_plus;
        self.epsilon_ab = epsilon_ab;
        self.b_params = b_params.abs().min(b_params.abs().recip());
    }
...
impl PcSaftYglPure {
    fn set_temperature_and_number_density(&mut self, temp: f64, rho_num: f64) {
        ...
        if self.no_assoc_term {
            ...
            let t = self.tT0D0();
            self.xa = (-(1.0 - self.b_params * t)
                + ((1.0 - self.b_params * t).powi(2) + 4.0 * (1.0 + self.b_params) * t).sqrt())
                / (2.0 * (1.0 + self.b_params) * t);
        }
    }
...
impl PcSaftYglPure {
    fn assocT0D0(&self) -> f64 {
        if self.no_assoc_term {
            ...
            self.xa.ln()
                + (self.b_params * self.xa + 1.0 - self.b_params).ln()
                + ((1.0 + self.b_params) * self.xa - self.b_params).ln()
                - (1.0 + self.b_params) * self.xa
                + (1.0 + self.b_params)
        }
    }
    fn assocT0D1(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT0D1(1.0, self.xa)
                + self.siteT0D1(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT0D1(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
        }
    }
    fn assocT0D2(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT0D2(1.0, self.xa)
                + self.siteT0D2(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT0D2(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT0D3(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT0D3(1.0, self.xa)
                + self.siteT0D3(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT0D3(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT0D4(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT0D4(1.0, self.xa)
                + self.siteT0D4(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT0D4(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT1D0(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT1D0(1.0, self.xa)
                + self.siteT1D0(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT1D0(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT1D1(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT1D1(1.0, self.xa)
                + self.siteT1D1(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT1D1(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT1D2(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT1D2(1.0, self.xa)
                + self.siteT1D2(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT1D2(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT1D3(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT1D3(1.0, self.xa)
                + self.siteT1D3(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT1D3(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
    ...
    fn assocT2D0(&mut self) -> f64 {
        if self.no_assoc_term {
            ...
            self.siteT2D0(1.0, self.xa)
                + self.siteT2D0(self.b_params, self.b_params * self.xa + 1.0 - self.b_params)
                + self.siteT2D0(
                    1.0 + self.b_params,
                    (1.0 + self.b_params) * self.xa - self.b_params,
                )
...
impl PcSaftYglPure {
    fn xt1(&self) -> f64 {
        (self.xa * (self.xa + self.b_params * self.xa - self.b_params)).powi(2)
            / ((1.0 + self.b_params) * self.xa.powi(2) - 2.0 * (1.0 + self.b_params) * self.xa
                + self.b_params)
    }
    fn xt2(&self) -> f64 {
        2.0 * (self.xa * (self.xa + self.b_params * self.xa - self.b_params)).powi(3)
            / ((1.0 + self.b_params) * self.xa.powi(2) - 2.0 * (1.0 + self.b_params) * self.xa
                + self.b_params)
                .powi(3)
            * ((1.0 + self.b_params).powi(2) * self.xa.powi(3)
                - 3.0 * (1.0 + self.b_params).powi(2) * self.xa.powi(2)
                + (3.0 * self.b_params * (1.0 + self.b_params) * self.xa - self.b_params.powi(2)))
    }
    fn xt3(&self) -> f64 {
        6.0 * (self.xa * (self.xa + self.b_params * self.xa - self.b_params)).powi(4)
            / ((1.0 + self.b_params) * self.xa.powi(2) - 2.0 * (1.0 + self.b_params) * self.xa
                + self.b_params)
                .powi(5)
            * ((1.0 + self.b_params).powi(4) * self.xa.powi(6)
                - 6.0 * (1.0 + self.b_params).powi(4) * self.xa.powi(5)
                + 5.0
                    * (3.0 * self.b_params + 2.0)
                    * (1.0 + self.b_params).powi(3)
                    * self.xa.powi(4)
                - 20.0 * self.b_params * (1.0 + self.b_params).powi(3) * self.xa.powi(3)
                + self.b_params.powi(2)
                    * (15.0 * self.b_params + 16.0)
                    * (1.0 + self.b_params)
                    * self.xa.powi(2)
                - (6.0 * self.b_params.powi(3) * (1.0 + self.b_params) * self.xa
                    - self.b_params.powi(4)))
    }
    fn xt4(&self) -> f64 {
        24.0 * (self.xa * (self.xa + self.b_params * self.xa - self.b_params)).powi(5)
            / ((1.0 + self.b_params) * self.xa.powi(2) - 2.0 * (1.0 + self.b_params) * self.xa
                + self.b_params)
                .powi(7)
            * ((1.0 + self.b_params).powi(6) * self.xa.powi(9)
                - 9.0 * (1.0 + self.b_params).powi(6) * self.xa.powi(8)
                + (36.0 * self.b_params + 29.0) * (1.0 + self.b_params).powi(5) * self.xa.powi(7)
                - 7.0
                    * (12.0 * self.b_params + 5.0)
                    * (1.0 + self.b_params).powi(5)
                    * self.xa.powi(6)
                + 21.0
                    * self.b_params
                    * (6.0 * self.b_params + 5.0)
                    * (1.0 + self.b_params).powi(4)
                    * self.xa.powi(5)
                - self.b_params.powi(2)
                    * (126.0 * self.b_params.powi(2) + 260.0 * self.b_params + 135.0)
                    * (1.0 + self.b_params).powi(2)
                    * self.xa.powi(4)
                + self.b_params.powi(3)
                    * (84.0 * self.b_params + 95.0)
                    * (1.0 + self.b_params).powi(2)
                    * self.xa.powi(3)
                - 3.0
                    * self.b_params.powi(4)
                    * (12.0 * self.b_params + 13.0)
                    * (1.0 + self.b_params)
                    * self.xa.powi(2)
                + (9.0 * self.b_params.powi(5) * (1.0 + self.b_params) * self.xa
                    - self.b_params.powi(6)))
    }
}
#[allow(non_snake_case)]
impl PcSaftYglPure {
...
mod tests {
    ...
    fn test_pc_saft_pure() {
        ...
        methanol.set_ygl_assoc_type(0.035176, 2899.5, 0.0);
        methanol.td_unchecked(300.0, 24514.0);
        methanol.check_derivatives(false);
        let mut methanol = PcSaftYglPure::new_fluid(1.5255, 3.23, 188.9);
        methanol.set_ygl_assoc_type(0.035176, 2899.5, 1.0);
        methanol.td_unchecked(300.0, 24514.0);
        methanol.check_derivatives(false);
    }
}
