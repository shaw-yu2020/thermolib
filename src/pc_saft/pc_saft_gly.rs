...
impl PcSaftGlyPure {
    fn t_t0d0(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * self.gii_gly_t0d0()
    }
    fn t_t0d1(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t0d1() + self.gii_gly_t0d0())
    }
    fn t_t0d2(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t0d2() + 2.0 * self.gii_gly_t0d1())
    }
    fn t_t0d3(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t0d3() + 3.0 * self.gii_gly_t0d2())
    }
    fn t_t0d4(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t0d4() + 4.0 * self.gii_gly_t0d3())
    }
    ...
    fn t_t1d1(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t1d1() + self.gii_gly_t1d0())
            - (self.epsilon_AB_temp.exp() * self.epsilon_AB_temp)
                * (self.gii_gly_t0d1() + self.gii_gly_t0d0())
    }
    fn t_t1d2(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t1d2() + 2.0 * self.gii_gly_t1d1())
            - (self.epsilon_AB_temp.exp() * self.epsilon_AB_temp)
                * (self.gii_gly_t0d2() + 2.0 * self.gii_gly_t0d1())
    }
    fn t_t1d3(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * (self.gii_gly_t1d3() + 3.0 * self.gii_gly_t1d2())
            - (self.epsilon_AB_temp.exp() * self.epsilon_AB_temp)
                * (self.gii_gly_t0d3() + 3.0 * self.gii_gly_t0d2())
    }
    fn t_t2d0(&mut self) -> f64 {
        (self.epsilon_AB_temp.exp() - 1.0) * self.gii_gly_t2d0()
            - 2.0 * self.epsilon_AB_temp.exp() * self.epsilon_AB_temp * self.gii_gly_t1d0()
            + (self.epsilon_AB_temp.exp() * self.epsilon_AB_temp)
...
impl PcSaftGlyPure {
    ...
    fn gii_gly_t1d0(&self) -> f64 {
        self.eta_dt1 / (1.0 - self.eta).powi(4)
            * ((3.0 * self.c0 + self.c1)
                + (2.0 * self.c1 + 2.0 * self.c2) * self.eta
                + self.c2 * self.eta.powi(2))
    }
    fn gii_gly_t1d1(&self) -> f64 {
        self.eta_dt1 / (1.0 - self.eta).powi(4)
            * ((3.0 * self.c0 + self.c1)
                + (2.0 * self.c1 + 2.0 * self.c2) * self.eta
                + self.c2 * self.eta.powi(2))
            + self.eta_dt1 * self.eta * 2.0 / (1.0 - self.eta).powi(5)
                * ((6.0 * self.c0 + 3.0 * self.c1 + self.c2)
                    + (3.0 * self.c1 + 4.0 * self.c2) * self.eta
                    + self.c2 * self.eta.powi(2))
    }
    fn gii_gly_t1d2(&self) -> f64 {
        2.0 * self.eta_dt1 * self.eta * 2.0 / (1.0 - self.eta).powi(5)
            * ((6.0 * self.c0 + 3.0 * self.c1 + self.c2)
                + (3.0 * self.c1 + 4.0 * self.c2) * self.eta
                + self.c2 * self.eta.powi(2))
            + self.eta_dt1 * self.eta.powi(2) * 6.0 / (1.0 - self.eta).powi(6)
                * ((10.0 * self.c0 + 6.0 * self.c1 + 3.0 * self.c2)
                    + (4.0 * self.c1 + 6.0 * self.c2) * self.eta
                    + self.c2 * self.eta.powi(2))
    }
    fn gii_gly_t1d3(&self) -> f64 {
        3.0 * self.eta_dt1 * self.eta.powi(2) * 6.0 / (1.0 - self.eta).powi(6)
            * ((10.0 * self.c0 + 6.0 * self.c1 + 3.0 * self.c2)
                + (4.0 * self.c1 + 6.0 * self.c2) * self.eta
                + self.c2 * self.eta.powi(2))
            + self.eta_dt1 * self.eta.powi(3) * 24.0 / (1.0 - self.eta).powi(7)
                * ((15.0 * self.c0 + 10.0 * self.c1 + 6.0 * self.c2)
                    + (5.0 * self.c1 + 8.0 * self.c2) * self.eta
                    + self.c2 * self.eta.powi(2))
    }
    fn gii_gly_t2d0(&self) -> f64 {
        self.eta_dt2 / (1.0 - self.eta).powi(4)
            * ((3.0 * self.c0 + self.c1)
                + (2.0 * self.c1 + 2.0 * self.c2) * self.eta
                + self.c2 * self.eta.powi(2))
            + self.eta_dt1.powi(2) * 2.0 / (1.0 - self.eta).powi(5)
                * ((6.0 * self.c0 + 3.0 * self.c1 + self.c2)
                    + (3.0 * self.c1 + 4.0 * self.c2) * self.eta
                    + self.c2 * self.eta.powi(2))
    }
