...
impl PcSaftPure {
    ...
    fn hcT0D3(&mut self) -> f64 {
        let giiT0D1: f64 = self.giiT0D1();
        self.m * self.hsT0D3()
            + (1.0 - self.m)
                * (2.0 / self.giiT0D0().powi(3) * giiT0D1.powi(3)
                    - 3.0 / self.giiT0D0().powi(2) * giiT0D1 * self.giiT0D2()
                    + 1.0 / self.giiT0D0() * self.giiT0D3())
    }
    fn hcT0D4(&mut self) -> f64 {
        ...
        self.m * self.hsT0D4()
            + (1.0 - self.m)
                * (-6.0 / self.giiT0D0().powi(4) * giiT0D1.powi(4)
                    + 12.0 / self.giiT0D0().powi(3) * giiT0D1.powi(2) * giiT0D2
                    - 4.0 / self.giiT0D0().powi(2) * giiT0D1 * self.giiT0D3()
                    - 3.0 / self.giiT0D0().powi(2) * giiT0D2.powi(2)
                    + 1.0 / self.giiT0D0() * self.giiT0D4())
    }
    ...
    fn hcT1D1(&mut self) -> f64 {
        self.m * self.hsT1D1()
            + (1.0 - self.m)
                * (-1.0 / self.giiT0D0().powi(2) * self.giiT1D0() * self.giiT0D1()
                    + 1.0 / self.giiT0D0() * self.giiT1D1())
    }
    fn hcT1D2(&mut self) -> f64 {
        ...
        self.m * self.hsT1D2()
            + (1.0 - self.m)
                * (2.0 / self.giiT0D0().powi(3) * giiT1D0 * giiT0D1.powi(2)
                    - 2.0 / self.giiT0D0().powi(2) * self.giiT1D1() * giiT0D1
                    - 1.0 / self.giiT0D0().powi(2) * giiT1D0 * self.giiT0D2()
                    + 1.0 / self.giiT0D0() * self.giiT1D2())
    }
    fn hcT1D3(&mut self) -> f64 {
        ...
        self.m * self.hsT1D3()
            + (1.0 - self.m)
                * (-6.0 / self.giiT0D0().powi(4) * giiT1D0 * giiT0D1.powi(3)
                    + 6.0 / self.giiT0D0().powi(3) * giiT1D1 * giiT0D1.powi(2)
                    + 6.0 / self.giiT0D0().powi(3) * giiT1D0 * giiT0D1 * giiT0D2
                    - 3.0 / self.giiT0D0().powi(2) * giiT1D1 * giiT0D2
                    - 3.0 / self.giiT0D0().powi(2) * self.giiT1D2() * giiT0D1
                    - 1.0 / self.giiT0D0().powi(2) * giiT1D0 * self.giiT0D3()
                    + 1.0 / self.giiT0D0() * self.giiT1D3())
    }
    fn hcT2D0(&mut self) -> f64 {
        self.m * self.hsT2D0()
            + (1.0 - self.m)
                * (-1.0 / self.giiT0D0().powi(2) * self.giiT1D0().powi(2)
                    + 1.0 / self.giiT0D0() * self.giiT2D0())
    }
}
#[allow(non_snake_case)]
impl PcSaftPure {
...
impl PcSaftPure {
    ...
    fn c1T0D3(&mut self, eta: f64) -> f64 {
        ...
        -6.0 * cT0D1.powi(3) / self.cT0D0(eta).powi(4)
            + 6.0 * cT0D1 * self.cT0D2(eta) / self.cT0D0(eta).powi(3)
            - self.cT0D3(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T0D4(&mut self, eta: f64) -> f64 {
        let cT0D1 = self.cT0D1(eta);
        let cT0D2 = self.cT0D2(eta);
        24.0 * cT0D1.powi(4) / self.cT0D0(eta).powi(5)
            - 36.0 * cT0D1.powi(2) * cT0D2 / self.cT0D0(eta).powi(4)
            + 8.0 * cT0D1 * self.cT0D3(eta) / self.cT0D0(eta).powi(3)
            + 6.0 * cT0D2.powi(2) / self.cT0D0(eta).powi(3)
            - self.cT0D4(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T1D0(&mut self, eta: f64) -> f64 {
        -self.cT1D0(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T1D1(&mut self, eta: f64) -> f64 {
        2.0 * self.cT1D0(eta) * self.cT0D1(eta) / self.cT0D0(eta).powi(3)
            - self.cT1D1(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T1D2(&mut self, eta: f64) -> f64 {
        let cT0D1 = self.cT0D1(eta);
        let cT1D0 = self.cT1D0(eta);
        -6.0 * cT1D0 * cT0D1.powi(2) / self.cT0D0(eta).powi(4)
            + 4.0 * self.cT1D1(eta) * cT0D1 / self.cT0D0(eta).powi(3)
            + 2.0 * cT1D0 * self.cT0D2(eta) / self.cT0D0(eta).powi(3)
            - self.cT1D2(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T1D3(&mut self, eta: f64) -> f64 {
        ...
        24.0 * cT1D0 * cT0D1.powi(3) / self.cT0D0(eta).powi(5)
            - 18.0 * cT1D1 * cT0D1.powi(2) / self.cT0D0(eta).powi(4)
            - 18.0 * cT1D0 * cT0D1 * cT0D2 / self.cT0D0(eta).powi(4)
            + 6.0 * cT1D1 * cT0D2 / self.cT0D0(eta).powi(3)
            + 6.0 * self.cT1D2(eta) * cT0D1 / self.cT0D0(eta).powi(3)
            + 2.0 * cT1D0 * self.cT0D3(eta) / self.cT0D0(eta).powi(3)
            - self.cT1D3(eta) / self.cT0D0(eta).powi(2)
    }
    fn c1T2D0(&mut self, eta: f64) -> f64 {
        2.0 * self.cT1D0(eta).powi(2) / self.cT0D0(eta).powi(3)
            - self.cT2D0(eta) / self.cT0D0(eta).powi(2)
    }
}
#[allow(non_snake_case)]
impl PcSaftPure {
